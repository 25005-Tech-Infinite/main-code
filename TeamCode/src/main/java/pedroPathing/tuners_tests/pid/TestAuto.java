...
public class TestAuto extends OpMode {
    ...
    private final Pose finalPose = new Pose(40, 0, Math.toRadians(90));
    ...
    public void init() {
        ...
        forwards = new Path(new BezierLine(new Point(startPose), new Point(finalPose)));
//        forwards = new Path(new BezierLine(new Point(0,0, Point.CARTESIAN), new Point(0,DISTANCE, Point.CARTESIAN)));
//        forwards.setLinearHeadingInterpolation(startPose.getHeading(), finalPose.getHeading());
