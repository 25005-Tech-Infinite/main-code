...
private double arm_multipler = 60;
    // PID Variables
...
//                    arm.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
                    ...
                    if (arm.getCurrentPosition() < 0) {
                        armTargetPosition = ((int) (arm.getCurrentPosition()+ arm_multipler));
//                        arm.setPower(-gamepad2.right_stick_y * -arm_multipler);
                    } else{
                        arm.setPower(0);
                    }
...
//                armTargetPosition = armTargetPosition + 2;
...
//            }
            ...
            telemetry.addData("Joystick Intake", gamepad2.left_stick_y);
            telemetry.addData("Arm power", -gamepad2.right_stick_y * arm_multipler);
